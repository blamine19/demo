...
class ProductResource extends Resource
{
    ...
    {
        return [
            \App\Filament\Resources\Shop\ProductResource\RelationManagers\CommentsRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => \App\Filament\Resources\Shop\ProductResource\Pages\ListProducts::route('/'),
            'create' => \App\Filament\Resources\Shop\ProductResource\Pages\CreateProduct::route('/create'),
            'edit' => \App\Filament\Resources\Shop\ProductResource\Pages\EditProduct::route('/{record}/edit'),
        ];
    }
    ...
    {
        return parent::getEloquentQuery()->where('id_user', 2);
    }
